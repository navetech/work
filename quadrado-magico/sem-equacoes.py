...
def get_solution_estim_vals(estim_vals_2_lines_permut, remain_estim_vals_permut, 
    ...
    solution = check_solution(values, line_length, num_values, max_value, line_sum):

    return solution


def get_solution_def_lines_estim_vals(def_lines_vals_permut, estim_vals_permut, 
    line_length, num_values, max_value, line_sum
    ):
...
def get_solution_def_lines(def_lines_vals_permut,
    line_length, num_values, max_value, line_sum
    ): 
...
def main():
    ...
    if num_def_lines < 1:
        ...
        for estim_vals_2_lines_permut in estim_vals_2_lines_permuts:
            ...
            remain_estim_vals_permuts = build_remain_estim_vals_permuts(
                all_estim_vals, estim_vals_2_lines_permut, line_length, line_sum
                )
            ...
            for remain_estim_vals_permut in remain_estim_vals_permuts:
                ...
                # Get solution
                solution = get_solution_estim_vals(estim_vals_2_lines_permut, remain_estim_vals_permut)
    ...
    # Else there are defined lines
        ...
        estim_vals_permuts = build_estim_vals_permuts(
            all_estim_vals, line_length, line_sum
            )
        ...
        for def_lines_vals_permut in def_lines_vals_permuts["inverted"]:
                ...
                for estim_vals_permut in estim_vals_permuts_list:
                    ...
                    # Get solution
                    solution = get_solution_def_lines_estim_vals(def_lines_vals_permut, estim_vals_permut) 
