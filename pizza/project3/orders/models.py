...
class SpecialPizza(models.Model):
    topping_1 = models.ForeignKey(Topping, on_delete=models.CASCADE, related_name="topping_1_specials")
    topping_2 = models.ForeignKey(Topping, on_delete=models.CASCADE, related_name="topping_2_specials")
    topping_3 = models.ForeignKey(Topping, on_delete=models.CASCADE, related_name="topping_3_specials")
    topping_4 = models.ForeignKey(Topping, on_delete=models.CASCADE, related_name="topping_4_specials")
...
class Pizza(models.Model):
    ...
    pizza_size = models.CharField(max_length=1, choices=MEAL_SIZES)
